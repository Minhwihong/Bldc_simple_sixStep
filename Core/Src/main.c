...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, LED1_Pin|LINK_DC_EN_Pin|BLDC_EN_Pin|LED2_Pin
                          |LED3_Pin|USART1_DE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BLDC_CAL_GPIO_Port, BLDC_CAL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED1_Pin LINK_DC_EN_Pin BLDC_EN_Pin LED2_Pin
                           LED3_Pin USART1_DE_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LINK_DC_EN_Pin|BLDC_EN_Pin|LED2_Pin
                          |LED3_Pin|USART1_DE_Pin;
  ...
  /*Configure GPIO pin : BLDC_CAL_Pin */
  GPIO_InitStruct.Pin = BLDC_CAL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BLDC_CAL_GPIO_Port, &GPIO_InitStruct);
