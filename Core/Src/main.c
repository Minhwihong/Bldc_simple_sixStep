...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, GPO_EXBOARD_LED_Pin|GPO_DBG_2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPO_DBG_3_Pin|GPO_DBG_1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GPO_DBG_3_Pin GPO_DBG_1_Pin */
  GPIO_InitStruct.Pin = GPO_DBG_3_Pin|GPO_DBG_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : GPO_DBG_2_Pin */
  GPIO_InitStruct.Pin = GPO_DBG_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPO_DBG_2_GPIO_Port, &GPIO_InitStruct);
